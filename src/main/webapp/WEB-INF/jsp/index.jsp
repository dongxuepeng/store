    ...
    <tr height="85%">
        <td width="10%" align="left" valign="top" style="background-color: #009E94">
            <ul class="layui-nav layui-nav-tree layui-bg-cyan layui-inline" lay-filter="navs" style="width: 100%;">
                ...
                <li class="layui-nav-item" id="kcgl">
                    <a href="javascript:;" data-id="kcgl">库存管理</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" data-id="kcgl_1">商品1</a></dd>
                        <dd><a href="javascript:;" data-id="kcgl_2">商品2</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item" id="shgl">
                    <a href="javascript:;" data-id="shgl">售货管理</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" data-id="shgl_1">商品1</a></dd>
                        <dd><a href="javascript:;" data-id="shgl_2">商品2</a></dd>
                    </dl>
                </li>
        ...
        <td width="90%" style="background-color: #555555" valign="top">
